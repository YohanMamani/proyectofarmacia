...
class Pedidos{
    ...
    function createPedido($nombrelaboratorio,$nombrefarmacia,$fechaconfirmacion,$mensaje){
        //creamos la conexión
        $conexion = $this->conectarBD();
        //Escribimos la sentencia sql necesaria respetando los tipos de datos
        $sql = "insert into notificaciones (nombrelaboratorio,nombrefarmacia,fechaconfirmacion,mensaje) 
        values ('".$nombrelaboratorio."','".$nombrefarmacia."','".$fechaconfirmacion."','".$mensaje."')";
