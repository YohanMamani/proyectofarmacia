  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-header with-border">
        ...
        <button class="btn btn-primary" data-toggle="modal" data-target="#confirmarpedido">

        <i class="fa fa-file-pdf"></i> Solicitar Productos
...
<div id="confirmarpedido" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-header" style="background:#3c8dbc; color:white">
          ...
          <h4 class="modal-title">Solicitar pedido</h4>
        ...
        <div class="modal-body">
          ...
          <div class="box-body">
              ...
              <center><h3>Confirmar si se desea solicitar el perdido</h3></center> 
              <input type="hidden" name="aceptar" value="si" />
          </div>
